...
public class JdbcTestBase {
    ...
    public static final String DROP_USERS = "DROP TABLE users";
    ...
    public PropertyResolver createPropertyResolver() {
        ...
        ps.put("xu-spring.datasource.url", "jdbc:sqlite:test.db");
        ps.put("xu-spring.datasource.username", "sa");
        ps.put("xu-spring.datasource.password", "");
        ps.put("xu-spring.datasource.driver-class-name", "org.sqlite.JDBC");
