package ioc.itranswarp.summer.context;
...
import ioc.itranswarp.scan.ScanApplication;
import ioc.itranswarp.scan.convert.ValueConverterBean;
import ioc.itranswarp.scan.custom.annotation.CustomAnnotationBean;
import ioc.itranswarp.scan.destroy.AnnotationDestroyBean;
import ioc.itranswarp.scan.destroy.SpecifyDestroyBean;
import ioc.itranswarp.scan.init.AnnotationInitBean;
import ioc.itranswarp.scan.init.SpecifyInitBean;
import ioc.itranswarp.scan.nested.OuterBean;
import ioc.itranswarp.scan.primary.DogBean;
import ioc.itranswarp.scan.primary.PersonBean;
import ioc.itranswarp.scan.primary.TeacherBean;
import ioc.itranswarp.scan.proxy.InjectProxyOnConstructorBean;
import ioc.itranswarp.scan.proxy.InjectProxyOnPropertyBean;
import ioc.itranswarp.scan.proxy.OriginBean;
import ioc.itranswarp.scan.proxy.SecondProxyBean;
import ioc.itranswarp.scan.sub1.Sub1Bean;
import ioc.itranswarp.scan.sub1.sub2.Sub2Bean;
import ioc.itranswarp.scan.sub1.sub2.sub3.Sub3Bean;
