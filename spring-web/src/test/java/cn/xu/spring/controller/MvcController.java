...
import cn.xu.spring.web.ModelAndView;
...
public class MvcController {
    ...
    ModelAndView product(@PathVariable("id") long id, @RequestParam("name") String name) {
        ModelAndView modelAndView = new ModelAndView("/product.html", Map.of("name", name, "product", Map.of("id", id, "name", "Summer Software")));
        return modelAndView;
    }
